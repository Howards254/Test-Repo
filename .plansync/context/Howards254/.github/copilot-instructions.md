<!-- plansync -->
# Simple PHP User Management System — Instructions for Howards254
...
**Acceptance Criteria:**
  ...
  - All user-controlled output is passed through e()/htmlspecialchars (no raw echo of variables in any view) — verified by grep for `<?= # Simple PHP User Management System — Instructions for Howards254
...
## Scope
You may only write to files matching the glob patterns listed above.
All other files in the project are read-only.
<!-- end-plansync -->
