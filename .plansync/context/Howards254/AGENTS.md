<!-- plansync -->
# PlanSync — Admin Context — Howards254
...
| Task | Title | Assignee | Status | Scope |
|------|-------|----------|--------|-------|
| T001 | Project scaffolding & config | Howards254 | ready | composer.json, public/index.php, public/.htaccess, config/config.php, .env.example, src/Core/Config.php |
| T002 | Database schema & PDO layer | Howards254 | ready | database/schema.sql, database/seed.php, src/Core/Database.php |
| T003 | Core infrastructure | Howards254 | ready | src/Core/Session.php, src/Core/Csrf.php, src/Core/Flash.php, src/Core/Request.php, src/Core/Router.php, src/Core/View.php |
| T004 | Authentication | calebomondi | ready | src/Controllers/AuthController.php, src/Core/Auth.php, src/Models/User.php, views/auth/login.php |
| T005 | Roles & permissions middleware | calebomondi | ready | src/Middleware/AuthMiddleware.php, src/Middleware/RoleMiddleware.php, src/Core/Router.php |
| T006 | User CRUD (admin) with search & pagination | calebomondi | ready | src/Controllers/UserController.php, src/Models/User.php, views/users/index.php, views/users/create.php, views/users/edit.php |
| T007 | User profile & password change | calebomondi | ready | src/Controllers/ProfileController.php, src/Models/User.php, views/profile/show.php, views/profile/edit.php |
| T008 | Base layout & Bootstrap UI | calebomondi | ready | views/layouts/app.php, views/partials/navbar.php, views/partials/flash.php, views/errors/403.php, views/errors/404.php |
| T009 | Security hardening pass | Howards254 | ready | src/Core/Csrf.php, src/Core/View.php, src/Controllers/AuthController.php, src/Controllers/UserController.php, src/Controllers/ProfileController.php, src/Models/User.php |
| T010 | README & setup docs | Howards254 | ready | README.md |
...
*PlanSync admin context for Howards254/Test-Repo*
<!-- end-plansync -->
